...
class Tracking:
    ...
    def __init__(self, team_name, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            wandb.init(entity=team_name, project=project_name, name=experiment_name, config=config, settings=settings)
